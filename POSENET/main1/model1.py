...
import sys
sys.path.insert(0, osp.join(r'E:\WWW\pythonProject\3DMPPE_ROOTNET_RELEASE-master\yolo3-pytorch-master\POSENET\common', 'nets'))
sys.path.insert(0, osp.join(r'E:\WWW\pythonProject\3DMPPE_ROOTNET_RELEASE-master\yolo3-pytorch-master\POSENET', 'main1'))
...
def get_pose_net1(cfg, is_train, joint_num):
