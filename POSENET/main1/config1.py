...
sys.path.insert(0, osp.join(r'E:\WWW\pythonProject\3DMPPE_ROOTNET_RELEASE-master\yolo3-pytorch-master\POSENET\common', 'utils'))

from dir_utils1 import add_pypath, make_folder
